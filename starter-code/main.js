      ...
      rl.question('Type an option: ', (option) => {
        switch (option) {
          ...
          case "4":
            ...
            break;
          case "5":
            db.collection('companies').find({ "founded_year": 2004 , $or: [{ "founded_month": 4 }, { "founded_month": 5 }, { "founded_month": 6 }]}, { name: 1, _id: 0 }).toArray((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
          ...
          case "7":
            ...
            break;
          case "8":
            db.collection('companies').find({"name": "Facebook"}).pretty((error, result) => {
              if (error) {
                console.log(error);
                rl.question(`\nType enter to continue: `, (answer) => { mainMenu() });
              } else {
